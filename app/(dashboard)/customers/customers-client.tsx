        ...
        <div className="max-w-[1600px] mx-auto">
          ...
          >
            ...
            <div className="p-6 space-y-6">
              <motion.div 
                className="bg-white/95 backdrop-blur-xl rounded-2xl border border-white/50 p-6 shadow-lg"
                whileHover={{ y: -2 }}
              >
              ...
              <motion.div 
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                className="bg-white/95 backdrop-blur-xl rounded-2xl border border-white/50 shadow-lg overflow-hidden"
              >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Link href="/customers/new">
                  <div className="bg-white/95 backdrop-blur-sm rounded-2xl border border-white/50 p-5 shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all text-center group cursor-pointer">
