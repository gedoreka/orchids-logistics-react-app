...
export function CommissionsClient({ companyId, initialPackages }: CommissionsClientProps) {
  ...
  const getModeLabel = (m: string) => {
    switch (m) {
      case "fixed_daily": return t("fixedDaily");
      case "fixed_monthly": return t("fixedMonthly");
                  ...
                  <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400 font-medium">
                        {emailDialog.commission?.status === 'paid' ? "سيتم إرسال نسخة من سند السداد للموظف" : "سيتم إرسال إشعار بالمطالبة المالية للموظف"}
                      </p>
                    </div>
                  </div>
      ...
      <div className="max-w-[1600px] mx-auto px-4 pt-8">
        ...
        >
          ...
          <div className="p-8 md:p-12 space-y-12">
            {/* Header Section */}
            <div className="relative rounded-[2rem] bg-white/10 backdrop-blur-xl p-8 text-white border border-white/10 shadow-xl overflow-hidden">
