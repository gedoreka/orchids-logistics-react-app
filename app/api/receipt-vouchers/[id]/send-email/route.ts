...
export async function POST(
  ...
  try {
    ...
    const htmlContent = `
      ...
      <head>
        ...
        <style>
          ...
          .total { background: #f8fafc; padding: 20px; border-radius: 12px; margin-top: 20px; text-align: center; }
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>سند قبض</h1>
            <p style="margin: 10px 0 0; opacity: 0.8;">Receipt Voucher</p>
          </div>
          <div class="content">
            <div class="info-row">
            ...
            <div class="total">
              ...
              <div class="total-amount">${Number(voucher.total_amount).toLocaleString('en-US', { minimumFractionDigits: 2 })} ر.س</div>
            </div>
          </div>
          <div class="footer">
    ...
    await transporter.sendMail({
      ...
      to: email,
      subject: `سند قبض رقم ${voucher.receipt_number} - ${company.name || 'الشركة'}`,
      html: htmlContent,
    });
