                      ...
                      <table className="w-full">
                        <thead>
                          <tr className="bg-gray-50 border-b border-gray-100">
                            ...
                            <th className="px-6 py-5 text-center text-[10px] font-black text-gray-400 uppercase tracking-widest">{t("status")}</th>
                            <th className="px-6 py-5 text-center text-[10px] font-black text-gray-400 uppercase tracking-widest print:hidden">{t("actions")}</th>
                          </tr>
                        </thead>
                        <tbody className="divide-y divide-gray-50">
                                  ...
                                  <td className="px-6 py-5 text-center">
                                    <div className="flex flex-col items-center gap-1.5">
                                      ...
                                      <span className={cn(
                                        ...
                                        {comm.status === "paid" ? t("paid") : t("unpaid")}
                                      </span>
                                    </div>
                                  </td>
