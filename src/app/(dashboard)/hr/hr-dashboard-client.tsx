    ...
    <div className="min-h-screen pb-20" dir={isRTL ? "rtl" : "ltr"}>
      ...
      >
        <motion.div 
          ...
          className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white/80 backdrop-blur-xl p-8 rounded-[2.5rem] border border-white/50 shadow-2xl"
        >
          <div>
            ...
            <h1 className="text-3xl font-black text-gray-900">{t('employeesSystem')}</h1>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/hr/packages">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="flex items-center gap-2 px-6 py-3 rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white hover:from-blue-700 hover:to-indigo-700 transition-all font-black text-sm shadow-lg shadow-blue-500/30"
              >
                <PlusCircle size={20} />
