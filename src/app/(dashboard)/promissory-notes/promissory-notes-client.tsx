      ...
      <head>
        ...
        <style>
          ...
          * { margin: 0; padding: 0; box-sizing: border-box; }
          body { font-family: 'Tajawal', sans-serif; direction: rtl; padding: 20px; background: #fff; }
          .print-container { max-width: 800px; margin: 0 auto; border: 3px double #1a365d; padding: 30px; background: #fff; }
          .header { text-align: center; margin-bottom: 30px; border-bottom: 2px solid #1a365d; padding-bottom: 20px; }
          .header h1 { font-size: 28px; color: #1a365d; font-weight: 700; }
          .meta-row { display: flex; justify-content: space-between; margin-bottom: 20px; font-size: 14px; }
          .content { line-height: 2.2; font-size: 16px; text-align: justify; margin-bottom: 30px; }
          .field { border-bottom: 1px dotted #333; min-width: 150px; display: inline-block; text-align: center; padding: 0 10px; font-weight: 600; color: #1a365d; }
          ...
          .signature-box p { margin-bottom: 10px; font-weight: 600; }
          .signature-line { border-bottom: 1px solid #333; height: 60px; margin-bottom: 10px; }
          .fingerprint-box { width: 80px; height: 80px; border: 2px solid #333; border-radius: 50%; margin: 0 auto; display: flex; align-items: center; justify-content: center; color: #999; }
          @media print { body { padding: 0; } .print-container { border: 3px double #1a365d; } }
        </style>
      </head>
      <body>
            ...
            >
              ...
              >
                ...
                <div ref={printRef} className="p-8" dir="rtl">
                  <div className="print-container border-4 border-double border-slate-800 p-8 bg-white">
                    <div className="text-center border-b-2 border-slate-800 pb-6 mb-6">
                      <h1 className="text-3xl font-bold text-slate-800 mb-2">سند لأمـــر</h1>
                      <p className="text-slate-600 text-sm">رقم السند: {selectedNote.note_number}</p>
                    </div>
                    ...
                    <div className="leading-loose text-justify mb-8 text-base">
                      <p className="mb-4">
                        أتعهد أنا الموقع أدناه بأن أدفع بموجب هذا السند بدون قيد أو شرط لأمر / 
                        <span className="font-bold text-emerald-700 border-b border-dotted border-slate-400 px-2">
                    ...
                    <div className="border-t-2 border-slate-300 pt-6 mt-8">
                      <div className="grid grid-cols-2 gap-8 mb-8">
                        <div>
                          <p className="font-bold mb-2">اسم المحرر:</p>
                          <p className="border-b border-dotted border-slate-400 pb-2 min-h-[30px]">
                            {selectedNote.debtor_name || "................................"}
                          </p>
                        </div>
                        <div>
                          <p className="font-bold mb-2">رقم الهوية:</p>
                          <p className="border-b border-dotted border-slate-400 pb-2 min-h-[30px]">
                      ...
                      <div className="flex justify-between items-start mt-12">
                        <div className="text-center">
                          <p className="font-bold mb-4">التوقيع:</p>
                          <div className="w-48 h-20 border-b border-slate-400 flex items-end justify-center">
                            <PenTool className="w-8 h-8 text-slate-300 mb-2" />
                          </div>
                        </div>
                        <div className="text-center">
                          <p className="font-bold mb-4">الإبهام (البصمة):</p>
                          <div className="w-24 h-24 border-2 border-slate-400 rounded-full flex items-center justify-center">
