                  ...
                  <div key={item.id} className={cn("bg-gray-50 rounded-xl p-4 border-blue-500", isRtl ? "border-r-4" : "border-l-4")}>
                    ...
                    <div className={cn("mt-2", isRtl ? "text-left" : "text-right")}>
                      <span className="text-xs text-gray-500">
                        {t("common.total")}: <span className="font-bold text-emerald-600">{(item.quantity * item.price).toLocaleString('en-US', { minimumFractionDigits: 2 })} {currency}</span>
                      </span>
                    </div>
                  </div>
                ))}
              ...
              <div className="p-5">
                <div className={cn("max-w-md space-y-3", isRtl ? "mr-auto" : "ml-auto")}>
                  ...
                  <div className="flex justify-between items-center py-2 border-b border-gray-100">
                    ...
                    <span className="font-bold text-amber-600">{vatAmount.toLocaleString('en-US', { minimumFractionDigits: 2 })} {currency}</span>
                  </div>
                  <div className="flex justify-between items-center py-3 bg-emerald-50 rounded-lg px-4">
                    ...
                    <span className="font-black text-2xl text-emerald-600">{total.toLocaleString('en-US', { minimumFractionDigits: 2 })} {currency}</span>
                  </div>
                </div>
              </div>
            </div>
