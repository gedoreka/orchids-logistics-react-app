            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { label: t("setupDate"), value: company.created_at ? new Date(company.created_at).toLocaleDateString('ar-SA') : "-", icon: Calendar, color: "text-purple-400", bg: "bg-purple-500/10" },
                ].map((item, i) => (
