...
const sections: Section[] = [
  ...
  {
    id: "manage-shipments",
    title: "إدارة شحنات الأفراد",
    titleEn: "Individual Shipment Management",
    description: "لوحة تحكم شاملة لإدارة جميع الشحنات وتحديث حالاتها وتأكيد الدفع والطباعة",
    icon: Package,
    href: "/ecommerce/individual-shipments/manage",
